                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('category.update', $category->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $category->title) }}" class="w-full bg-gray-900 border border-gray-700 rounded-md text-white px-4 py-2 focus:border-indigo-500 focus:ring focus:ring-indigo-500/20" required autofocus>
                            @error('title')
